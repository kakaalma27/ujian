...
class HomeController extends Controller
{
    ...
    {
        $ujian = User::where('role', 0)->pluck('id');
        $siswaUjian = usersUjian::whereIn('user_id', $ujian)->count();
        $totalSiswa = User::where('role', 0)->count();
        $siswaTidakUjian = $totalSiswa - $siswaUjian;
        
        return view('guru.home', compact('siswaUjian', 'siswaTidakUjian', 'totalSiswa'));
    }
